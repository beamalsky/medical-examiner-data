  ...
  return (
    <>
      <h4 style={{textAlign: "center"}}>
        June 2020 per capita COVID-19 deaths by Chicago neighborhood
      </h4>
      <CommunityAreaMap
        title={`June 2020 per capita COVID-19 deaths by Chicago neighborhood`}
...
export const query = graphql`
  query MapWithTextJuneQuery {
    community_areas:allFile(
      filter: {sourceInstanceName: {eq: "geojsonJune"}}
    ) {
      nodes {
        childGeoJson {
          features {
